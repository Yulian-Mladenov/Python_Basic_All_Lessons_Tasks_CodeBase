...
# the result of the first movie is ok
# the result of the second movie return 36,00% instead of 100.00% -  that is not correct.
# after finish instead of terminate the program and print four results, it continue to expect input

# probably solutions: the place of the code blocks and variables in the scopes are not correct. Probably is
# necessary to use flag variables to use the Finish statement to terminate the program and print the results.
